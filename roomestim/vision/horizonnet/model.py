# Vendored from github.com/sunset1995/HorizonNet @ c9a7df9, MIT (c) 2019 Cheng Sun;
# trimmed to inference essentials for roomestim.
#
# MIT License — Copyright (c) 2019 Cheng Sun. See ./LICENSE for the full text.
import numpy as np
